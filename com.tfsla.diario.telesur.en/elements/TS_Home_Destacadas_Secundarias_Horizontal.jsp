...
<div class="wpArticlesMin">
      ...
      <nt:news-list order="priority desc,user-modification-date desc" zone="destacada_secundaria" onmainpage="home" size="5" publication="9" searchindex="<%=index%>">
        ...
        <meta itemprop="sameAs url" content="<nt:link/>"/>
            ...
            <nt:preview-image>              
                ...
                <img itemprop="contentURL" src="<nt:image-path width='190' height='107' scaletype='4'/>"  alt="${imageDescription}" />
                    </a>
            </nt:preview-image>	 
