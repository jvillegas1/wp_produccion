					...
					<div itemprop="image" itemscope itemtype="http://schema.org/ImageObject">
						...
						<nt:preview-image>
							...
							<a href="<nt:link/>" title="${imageDescription}">	
								...
								<img itemprop="contentURL" src="<nt:image-path width='610' height='342' scaletype='2'/>" alt="${imageDescription}" />
							</a>
                    ...
                    <article>
                        <div class="wpSmallImg">
                            <nt:preview-image> 
                                ...
                                <img itemprop="contentURL" src="<nt:image-path width='146' height='82' scaletype='4' />" alt="${imageDescription}" />   	
                                 </a>
                            </nt:preview-image>
                        </div>
                        <div class="overflow">
