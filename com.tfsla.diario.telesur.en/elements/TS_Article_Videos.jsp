...
<script>
    ...
    items = [];
    duracion = [];
    var api = "http://multimedia.telesurtv.net/en/api/clip/?detalle=completo&seleccionado=true&ultimo=10";
    var urlCategoria = "http://multimedia.telesurtv.net/web/telesur/#!en/lista/noticia/";
