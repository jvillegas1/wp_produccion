...
<nt:news-list advancedfilter="<%=query%>" size="10" page="<%=pagina %>" state="publicada" order="user-modification-date" publication="9">
	
	<nt:conditional-include oncondition="${newslist.absoluteposition == 1 }">
		<div class="rowInt">
		        
		        <div class="headers blue">Recent posts</div>
		        <div class="cont">
	...
	<nt:conditional-include onposition="last">
		...
		<nt:news-list advancedfilter="<%=query%>" size="10" page="<%=pagina+1 %>" state="publicada" order="user-modification-date" publication="9">
	...
	<nt:conditional-include oncondition="${newslist.absoluteposition == 1 }">
		...
		<script type="text/javascript">
			function cargarMasNotas(_proxPag, _userName){
				...
				$.post("/system/modules/com.tfsla.diario.telesur.en/elements/webusers/TS_Profile_NewsList.jsp",
