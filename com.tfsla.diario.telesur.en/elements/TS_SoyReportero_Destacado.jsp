...
<div class="cont" itemscope itemtype="http://schema.org/Article">
	<nt:news-list section="imreporter" order="priority desc,user-modification-date desc" state="publicada" onmainpage="section" zone="destacada" size="1" searchindex="<%=index%>">   
					...
					<nt:user username="${internalUser}">
						<div class="inforepo">
							...
							<div class="autrepo" itemprop="author" itemscope itemtype="http://schema.org/Person">
								...
								<a href="/english<nt:user-link-friendly />" class="her" alt="${usuario}" title="${usuario}"> ${usuario} </a>
							</div>
