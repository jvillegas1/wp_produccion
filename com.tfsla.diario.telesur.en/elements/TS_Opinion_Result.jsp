...
%> 
	<!--/**
        ...
        *
        */ --> 
	<nt:news-list size="100" order="<%=order %>" tags="<%=query%>" from="<%=published_form %>" author="<%=filter_autor%>" section="<%=section_form %>" category="<%=filter_form %>" state="publicada">
		<% cont++; %>
	</nt:news-list> 
<%
 	}
...
<div class="row clear">
	<div class="cont">
		...
		<div class="menusearchbot">
			<div class="pagsearch">Page <%=pag %> of <%=cont%>  results</div>
			<a href="#" class="btnmost" data-order="LAST" >Most recent </a><a href="#" class="btnmost" data-order="RELE" >Less recent </a>
		</div>
	</div>
...
<div class="row clear">
	<div class="cont">
		<div class="titlereg">Results  <%=filter_form %> <%=filter_autor%><%--=q %> -- <%=t %> - <%=query %> -<%--=size %> - <%=query %> - <%=index %> - <%=pag %> - <%=result %> - <%=section_form --%></div>
		...
		<div class="ressearch" itemscope itemtype="http://schema.org/Article">
			...
			*/ --> 
			...
			<nt:news-list order="<%=order %>" size="<%=size%>" tags="<%=query%>" from="<%=published_form %>" page="<%=pag %>" author="<%=filter_autor%>" category="<%=filter_form %>" state="publicada"> 
...
%>
<form name="buscadorFooter" class="formSearchFooter" action="/english/searchOpinion.html" method="post" style="display:none"> 
