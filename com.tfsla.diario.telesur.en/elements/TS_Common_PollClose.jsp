...
if (grupo.indexOf("Programa") > -1 ||  grupo.indexOf("Sport") > -1 || grupo.indexOf("Club") > -1 ) 
{
...
<% if (!category.equals("") && !grupo.equals("")){ %>
	<article class="encuesta"><nt:polls-box size="1" state="inactive" category="<%=category%>" group="<%=grupo%>" style="TS-EN/CLOSE">
	</nt:polls-box></article>
<% }%>

<% if (!category.equals("") && grupo.equals("")){ %>
	<article class="encuesta"><nt:polls-box size="1" state="inactive" category="<%=category%>" style="TS-EN/CLOSE">
	</nt:polls-box></article>
<% }%>

<% if(category.equals("") && !grupo.equals("")){ %>
     	<article class="encuesta"><nt:polls-box size="1" state="inactive" group="<%=grupo%>" style="TS-EN/CLOSE">
	</nt:polls-box></article>
<% } %>
