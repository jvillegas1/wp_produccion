...
<nt:news-list order="priority desc,user-modification-date"  publication="9" onmainpage="home" zone="agenda_header" size="3" >
	 <% i++; %>
    		...
    		<a href="<nt:link/>">                   	
	        		...
	        		<nt:preview-image>		        		
                                        ...
                                        <nt:conditional-include oncondition="${imageDescription != ''}">
                                            		...
                                            		<span class="inf">${news.titles[news.titleSectionNum]}</span>
                                        </nt:conditional-include>
                                        <nt:conditional-include oncondition="${imageDescription == ''}">
                                            		<img src="<nt:image-path />" draggable="false" alt='${news.titles}' style="max-height: <%if(i == 1){%>353<%}else{%>173<%}%>px !important;"/>
                                            		<span class="inf">${news.titles[news.titleSectionNum]}</span>
                                        </nt:conditional-include>	                                        
                            	</nt:preview-image>			                                 
                        </nt:conditional-include>            
