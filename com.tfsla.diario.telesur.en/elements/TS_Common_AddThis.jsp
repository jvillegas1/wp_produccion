...
<div class="addthis_toolbox addthis_default_style addthis_16x16_style" addthis:title='<%=titulo%>' addthis:url="www.telesurtv.net<%=link%>" >
...
<script type="text/javascript" src="//s7.addthis.com/js/300/addthis_widget.js#pubid=ra-5526cf6d4144ea13" async="async"></script>
