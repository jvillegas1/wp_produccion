...
%>
<%--
<nt:news-list  order="most-commented, priority asc, user-modification-date desc"  section="analysis" zone="normal" from="7d" age="7d"  searchindex="<%=index%>">
	<% cont++; %>
</nt:news-list>
--%>
...
<% if (cont > 0) { %>	
	<div class="cont">
		<ul>
			<nt:news-list  order="most-commented, priority asc, user-modification-date desc" section="analysis" from="7d" age="7d" zone="normal" size="3" searchindex="<%=index%>">
				<li >
					<div class="popbox">
