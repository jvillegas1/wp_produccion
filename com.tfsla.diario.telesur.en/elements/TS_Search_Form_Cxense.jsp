...
<div class="blueBar redbg">
	<form name="buscador" class="formSearch1" action="/english/searchAdvanced.html" method="post">    	
					...
					<div class="cont">
						...
						<div class="contesel change1 changeadvanced" >
							<div class="filasel" >
								...
								<input type="text" name="search_form" value="<%=search_form %>" class="contsearch1" id="parameter" placeholder="Enter a search term" > 
						...
						<div class="contesel" id="ocultarfiltro">
							...
							<div class="filasel" id="ocultarfiltro3" ></div>
								<div class="desktop">
								   <input type="button" id="buscar" class="subscribeSearch btn-click advanced" value="Advanced Search">  
								</div>
							</div>
						</div>
