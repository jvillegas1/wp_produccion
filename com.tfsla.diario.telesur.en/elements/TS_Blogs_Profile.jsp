		...
		<nt:conditional-include oncondition="${internalUser != ''}">
			<nt:user username="${internalUser}">
				<div class="cont conttitle">
					<div class="titsoyrep">Blogger Profile</div>									
					<div class="contsp">
							...
							<div class="rightsp">
								...
								<div class="fbblogrs">
									...
									<script>(function(d, s, id) {
							                      ...
							                      js.src = "//connect.facebook.net/en_US/sdk.js#xfbml=1&appId=717538144973953&version=v2.0";
							                      fjs.parentNode.insertBefore(js, fjs);
							                    }(document, 'script', 'facebook-jssdk'));
							                </script>
                    
						                    <div class="fb-like" data-href="http://www.telesurtv.net<nt:user-link-friendly />" data-layout="button" data-action="like" data-show-faces="false" data-share="false"></div>
						                  </div>
						                  <!-- end like fb -->
						...
						<% if (cont > 1) { %>
							<div class="botsoyrepo" >
								...
								<div class="autrepo blue margrep">Other articles by this blogger</div>	
