...
<nt:news path="<%=path %>" >				
	<div class="news" itemscope itemtype="http://schema.org/Article" <% if ( usuarios ) { %> style="padding:3%; width:94%; background-color:#F6F6F6; margin-bottom:20px" <% } %> >	
		<nt:preview-image>
		...
		<% } %>  
		<% if ( usuarios ) { %>
			<p><a class="new-autor" href="<nt:link/>" alt="Full Story" title="Full Story">Full Story</a></p>
		<% } %>
	</div>
</nt:news>