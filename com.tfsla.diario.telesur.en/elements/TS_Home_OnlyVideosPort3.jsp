...
<nt:news-list order="priority desc,user-modification-date" zone="destacada" onmainpage="home" size="1" publication="9">
	...
	<script>
		...
		api no traiga resultados, esto con el fin de que el bloque no quede en blanco.		
		 --%>
		var api= "http://multimedia.telesurtv.net/en/api/clip/?detalle=completo=true&ultimo=6&hashtag="+hashtag[0]+"&hashtag=";
		console.log(api);
	
		var urlCategoria = "http://multimedia.telesurtv.net/en/api/clip/?detalle=completo&ultimo=6";
		    ...
		    success: function(data){
		    	...
		    	for(var j = 0; j < len; j++){
		    		...
		    		if(entry.categoria != null){
		    			...
		    			categoria.push("News");
		    			categoriaLink.push(urlCategoria);
		    		}
		    	}
