...
String categoryPath = "/system/categories/SubSecciones/en/multimedia/"+destacada+"/"; 
String referencia = "/SubSecciones/en/multimedia/"+category+"/index.html";
         ...
         <article class="mmdDst">
            ...
            <small><%= etiqueta %></small>                           
                ...
                <h4 itemprop="description alternativeHeadline">
                	<nt:sub-title maxlength='270' endchars='...' fullword="true" /><a href="<nt:link/>" title="<nt:title value='home' />"> Read more </a>
                </h4>	            
           </div> 
           <h8><a class="seeall" href="<%= referencia %>">See All</a></h8>             
        </article>	   
    </nt:news-list>
</div> 
<a class="verTodosMov" href="#">See All</a>