...
<footer id="footer">
	<div class="wrap">
		<div class="colFoot logoFoot">
			...
			<ul class="footMobile">
				<li><a href="<cms:link>/english/pages/termsconditions.html</cms:link>">Terms & Conditions</a></li>
				<li>|</li>
				<li><a href="<cms:link>/english/pages/privacy.html</cms:link>">Privacy</a></li>
				<li>|</li>
