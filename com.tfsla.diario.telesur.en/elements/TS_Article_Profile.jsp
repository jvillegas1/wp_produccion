			...
			<nt:conditional-include oncondition="${internalUser != ''}">
				<nt:user username="${internalUser}">
					<div class="cont conttitle">
						...
						<div class="titsoyrep">Reporter Profile</div>
						...
						<div class="contsp"  style="width:350px !important;">
							<div class="topsoyrepo">
								...
								%>
									...
									<a href="/english<%=urlFrendlyClean%>" class="her">	
								...
								<div class="rightsp">
									<div class="autrepo"> 		
										<a href="/english<%=urlFrendlyClean%>" class="her" alt="${usuario}" title="${usuario}"> ${usuario} </a>
						           		</div>
							...
							<% if (cont > 1) { %>
								<div class="botsoyrepo" >
									...
									<div class="autrepo blue margrep">Other articles by this reporter</div>
