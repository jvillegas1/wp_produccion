...
<footer id="footer">
	<div class="wrap">
		...
		<div class="colFoot">
			...
			<a href="/SubSecciones/en/news/technology/index.html">Technology</a>
		...
		<div class="colFoot">
			<h4>Services</h4>
			<a href="/english/pages/ServicesCatalogue.html">Services Catalogue</a>			
		...
		<div class="colFootRedes">
			<div class="wpRedesFoot">
				<a href="https://www.facebook.com/telesurenglish/" target="_blank"><cms:img src="/arte/redes/footer/facebook.png" scaleType="2" alt="facebook" /></a>
				<a href="https://twitter.com/telesurenglish" target="_blank"><cms:img src="/arte/redes/footer/twitter.png" scaleType="2" alt="twitter" /></a>
				<a href="https://plus.google.com/b/109863268290989520506?hl=en" target="_blank"><cms:img src="/arte/redes/footer/gplus.png" scaleType="2" alt="google plus" /></a>
				<a href="http://instagram.com/telesurenglish/" target="_blank"><cms:img src="/arte/redes/footer/instagram.png" scaleType="2" alt="instagram" /></a>
				<a href="http://www.pinterest.com/telesurenglish/" target="_blank"><cms:img src="/arte/redes/footer/pinterest.png" scaleType="2" alt="pinteres" /></a>
				<a href="https://www.youtube.com/user/telesurenglish" target="_blank"><cms:img src="/arte/redes/footer/youtube.png" scaleType="2" alt="youtube" /></a>
			</div>
