    ...
    <div class="content v3 p2">	
        <nt:news-list order="priority desc,user-modification-date" zone="destacada" onmainpage="home" size="1" publication="9" searchindex="<%=index%>">	
            ...
            <article class="important port2" >
                ...
                <h4><nt:sub-title maxlength="153" /> | <a href="<nt:link/>">READ MORE</a></h4>	
        ...
        <cms:include page="TS_Home_Destacadas_Secundarias_Horizontal.jsp" />              
   ...
   <aside class="v3 p2">
      	<div class="bnrs-side">
						...
						<cms:include page="TS_Common_Banners.jsp">
							...
							<cms:param name="key">Advert-300x480</cms:param>
						</cms:include>
