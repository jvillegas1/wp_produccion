...
<header id="header">
	<div class="wrap">
		...
		<div class="barMid">        
			...
			<a href="/english/index.html" class="logo">
				<div class="isoLogo"><cms:img src="/arte/log-iso-telesur.png" scaleType="2" alt="Telesur" /></div>
				<div class="tipoLogo"><cms:img src="/arte/logo-tipo-telesur_EN.png" scaleType="2" alt="Telesur" /></div>
			</a>
			
			
	
			<div class="vivo">
					<c:import url="http://www.telesurtv.net/_static_rankings/static_liveHeaderEngN.html?ramdon=<%=n%>"/>
			</div>
		</div>
