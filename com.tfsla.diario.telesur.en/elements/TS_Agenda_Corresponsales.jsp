...
items_cor = [];
var api_cor = "http://multimedia.telesurtv.net/en/api/clip/?detalle=completo&corresponsal=no_es_nulo&ultimo=6";
var corresponsalURL = "http://multimedia.telesurtv.net/web/telesur/#!en/lista/noticia/corresponsales--";
...
$.ajax({
    ...
    success: function(data){
  	...
  	items_cor.push("<h6>Correspondents <img src='/arte/agenda/i-corres.jpg' alt='Telesur' style=' height:40px; width:40px;'></h6>");
	for(var i = 0; i < len; i++){
