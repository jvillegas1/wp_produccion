...
<div class="row clear">  
	<div class="col">
		<div class="rowInt">
			<div class="headers blue">Articles</div>
			<div class="cont">
				...
				<span style="color: rgb(255, 253, 253); font-family: &quot;Arimo&quot;,sans-serif; border-radius: 5px; text-align: center; line-height: 15px; margin: 50px; font-style: italic; background-color: rgb(26, 32, 66); padding: 5px; font-size: 12px;"> The opinions expressed in this section do not necessarily represent those of teleSUR </span>
				<br>
				<br>
				<hr>
				<div class="btnopi">
					<a class="seemore desktop" id="seemore-articles" href="#" title="See more" alt="See more">See more</a>
				</div>	
		   	</div>
