...
html += "            						<span color=\"#000000\" style=\"font-size:x-large;font-family:Arial,Helvetica,sans-serif\"><strong> We have recieved a story </strong></span>	";						
html += "            					</td>";
html += "						<td width=\"21\" ></td>";
html += "            				</tr>";
html += "                   			<tr>";
...
html += "                                            									<span size=\"5\" face=\"Arial, Helvetica, sans-serif\" color=\"#000000\" style=\"font-size:medium;font-family:Arial,Helvetica,sans-serif\"><strong>Title:</strong></span>";
html += "                                            								</td>";
...
html += "                                            							<tr>";
html += "                                            								<td width=\"61\" valign=\"top\">";
html += "                                            									<span size=\"5\" face=\"Arial, Helvetica, sans-serif\" color=\"#000000\" style=\"font-size:medium;font-family:Arial,Helvetica,sans-serif\"><strong>Name:</strong></span>";
html += "                                            								</td>";
html += "                                            								<td width=\"303\" valign=\"top\">";
...
html += "                                            							<tr>";
html += "                                            								<td width=\"61\" valign=\"top\">";
html += "                                            									<span size=\"5\" face=\"Arial, Helvetica, sans-serif\" color=\"#000000\" style=\"font-size:medium;font-family:Arial,Helvetica,sans-serif\"><strong>Phone Number:</strong></span>";
html += "                                            								</td>";
html += "                                            								<td width=\"303\" valign=\"top\">";
...
html += "                                            							<tr>";
html += "                                            								<td width=\"61\" valign=\"top\">";
html += "                                            									<span size=\"5\" face=\"Arial, Helvetica, sans-serif\" color=\"#000000\" style=\"font-size:medium;font-family:Arial,Helvetica,sans-serif\"><strong>Message:</strong></span>";
html += "                                            								</td>";
html += "                                            								<td width=\"303\" valign=\"top\">";
...
mail.addTo("telesuringles@telesurtv.net");
mail.setFrom(email);
mail.send(); 	
%>