...
<ul>
	<li><a href="#" <% if (pageSeccion.equals("home")) {  %> class="active" <% } %> >Home</a></li>
...
%>				
				<li class="${active}">
					...
					<cms:contentcheck ifexists="Link">
						<a class="${active}"  href="<cms:contentshow element="Link" />" <% if ( Parametros.equals(pageSeccion) ) { %>class="select" <% } %> title="<cms:contentshow element="Descripcion" />"><cms:contentshow element="Descripcion" /></a>
					</cms:contentcheck>
...
%>
									...
									<cms:contentcheck ifexists="Link">
										<li><a class="${active}" href="<cms:contentshow element="Link" />" title="<cms:contentshow element="Descripcion" />"><cms:contentshow element="Descripcion" /></a></li>
									</cms:contentcheck>
