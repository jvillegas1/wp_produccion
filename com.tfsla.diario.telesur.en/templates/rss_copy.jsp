...
<channel>
 ...
 <nt:news-list order="user-modification-date DESC" advancedfilter="seccion:news AND NOT home.zone:ultimas " size="${cantidad}" >
      <item>
     ...
     <nt:video-flash>
            <enclosure url="<%=request.getScheme()+"://"+request.getServerName()%><nt:video-path/>" type="video/x-flv">
            </enclosure>
     </nt:video-flash>
