...
<cms:include page="../elements/TS_Common_Header.jsp" >            
    <div class="subMenu">
        <cms:param name="pageTitle">Web Specials</cms:param>
...
<script type="text/javascript">
    ...
    function loadMore(size, page) {
        ...
        $("#reload-listado").load('listing.html?size=' + size + '&page=' + page + '&category=webspecial&titulo=Specials', function(response, status, xhr) {
            $('#cargando').html("");
        });
