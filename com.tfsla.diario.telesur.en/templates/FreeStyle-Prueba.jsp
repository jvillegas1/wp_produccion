...
<head>
	...
	<script src="<cms:link>/system/modules/com.tfsla.diario.telesur/resources/js/team.js</cms:link>"></script>
	<script src="<cms:link>/system/modules/com.tfsla.diario.telesur/resources/js/funcion.js</cms:link>"></script>
