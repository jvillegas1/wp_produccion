...
<html>
<head>
<title>teleSUR English - Audios</title>
	...
	<cms:include page="../elements/TS_Common_Head.jsp" >
		...
		<cms:param name="copy">no</cms:param>
                ...
                <script type="text/javascript">    
                 function cargarMasNotas2(_pagina, _size, _filter_category) {
            ...
            $.post("/system/modules/com.tfsla.diario.telesur.en/elements/TS_Audio_Page.jsp",
                    {pagina: _pagina, size: _size ,filter_form: _filter_category}, function (data) {
                $(div).html(data);
...
<body>
	...
	<div class="wrapper"><!--wrapper--> 
		...
		<div class="row clear marginchica"> 
			...
			<cms:include page="../elements/TS_Audio_Search.jsp" />
