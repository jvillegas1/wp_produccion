...
<head>
	...
	<cms:include page="../elements/TS_Common_Head.jsp" >
		...
		function cargarMasNotas(_proxPag, _category, _title, _size){
			...
			$.post("/system/modules/com.tfsla.diario.telesur.en/elements/TS_Country_Page.jsp",
		...
		<div class="row clear marginchica"> 
	    	...
	    	<div class="row clear">   
		   	<!-- inicio colmna izq col-six -->
				...
				<div class="rowInt">      	
					<div class="cont">	
						<nt:news-list order="user-modification-date desc" category="<%=category%>" publication="9">
							<%contNota++;%>	
						</nt:news-list>	
						<% if (contNota == 0){ %>
							<div class="fraseComment">No news in this category.</div>
						<% } else { %>																																		 
