...
<div class="cont">
	...
	<div class="slideVerticalNew carousel">
			<nt:news-list newstype="News" order="user-modification-date desc" section="opinion" size="4" from="7d" age="7d" publication="9">
				<% cont1++; %>
			</nt:news-list>
	...
	<div id="MostRead">            
		<div class="slideVerticalNew carousel">
			<nt:news-list newstype="opinion" order="most-read" section="opinion" size="4" from="7d" age="7d" publication="9">
				<% cont2++; %>
			</nt:news-list>
			<ul <% if (cont2 > 5) { %> id="slideVerticalBlog2" <% } %> >
	                    	<nt:news-list newstype="News" order="most-read" section="opinion" size="4" from="7d" age="7d" publication="9"> 
		                        <li>
		                            <div class="modnews">
		                                <div class="contimgsli">
		                                	<nt:preview-image>									
	...
	<%--<div id="MostShared">            
		<div id="cx_66f7bdb42e91886ccde1c758ad8d689683ae80e7" style="display:none"></div>
		<script type="text/javascript">
		    var cX = cX || {}; cX.callQueue = cX.callQueue || [];
		    cX.callQueue.push(['insertWidget', {
		        widgetId: '66f7bdb42e91886ccde1c758ad8d689683ae80e7',
		        insertBeforeElementId: 'cx_66f7bdb42e91886ccde1c758ad8d689683ae80e7',
			...
			<%--<nt:news-list newstype="opinion" order="most-positive-evaluations" section="opinion" size="4" from="7d" age="7d" publication="9">
				<% cont3++; %>
			</nt:news-list>
			<ul <% if (cont3 > 5) { %> id="slideVerticalBlog3" <% } %> >
	                    	<nt:news-list newstype="News" order="most-positive-evaluations" section="opinion" size="4" from="7d" age="7d" publication="9"> 
		                        <li>
		                            <div class="modnews">
		                                <div class="contimgsli">
		                                	<nt:preview-image>									
