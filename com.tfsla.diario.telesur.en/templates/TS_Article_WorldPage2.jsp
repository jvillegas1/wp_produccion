...
<nt:news>
    ...
    <div id="container">
            ...
            <div class="wrapper">
             ...
             <%--   <cms:include page="../elements/TS_Common_Addthis-Sidebar-ingles.jsp">
                                            ...
                                            <nt:authors>
                                                ...
                                                <c:if test="${internalUser != ''}">
                                                    <nt:user username="${internalUser}">
                                                        ...
                                                        <span style="font-size:12px">By:</span> <span class="itacaput"><a href="<nt:user-link-friendly urlpart='/english/staff/'/>" class="her" alt="<nt:user-firstname/> <nt:user-lastname/>" title="<nt:user-firstname/> <nt:user-lastname/>"><nt:user-firstname/> <nt:user-lastname/></a></span>									
                                                    </nt:user>
                                                </c:if>	 
                                                <c:if test="${internalUser == '' && authorName != ''}">
                                                    <meta itemprop="name" content="<nt:author-name/>"/>
                                                    <span style="font-size:12px">By:</span> <span class="itacaput"><a style="width: auto" class="her" alt="<nt:author-name/>" title="<nt:author-name/>"><nt:author-name/></a></span>
                                                </c:if>
                                                <br/>
                                            </nt:authors>
                                        </div>
                                ...
                                <div class="capworldtop">
                                    <div class="caplw">
                                        <nt:conditional-include oncondition="${news.hideTime == 'false'}">
                                            ...
                                            <div class="capdate" itemprop="datePublished">Published <fmt:setLocale value="en_US"/> <nt:last-modified format="d MMMM yyyy"/> <%  try {%> <%=CalcularDias(horaNotaSistema)%> <% } catch (Exception e) {
                                                                                    } %></div>
                                        </nt:conditional-include>
                                    </div>
                                    ...
                                    <div class="caprw">
                                      ...
                                      <%--  <div class="gblogrs">		 
                                            ...
                                            <cms:img src="/arte/globe-red.png" width="27" height="23" alt="Coments" title="Coments" /> 
                                            <a href="#comsup"  alt="Comens" title="Coments" class="readblog">+</a>                                  									
                                        </div>	
				...
				<cms:param name="titulo"><nt:title value="detail" /></cms:param>
                        ...
                        <div class="col-300">
                            <div class="row clear"> 
                                <cms:include page="../elements/TS_Common_interna_bloque_ingles.jsp"> </cms:include>                                                            </div>
                         </div>
                        <!-- fin widget interno Cxense -->
					...
					<div class="tagBarNews" itemprop="keywords" itemscope="" itemtype="http://data-vocabulary.org/Breadcrumb">			              	
						...
						<a href="/english/people/index.html?personId=<nt:people-item-id/>&personName=<nt:people-item/>" alt="<nt:people-item/>" title="<nt:people-item/>" itemprop="title"><nt:people-item/></a>
					  	<nt:conditional-include onposition="last">
					 </div>	
					</nt:conditional-include>
				</nt:people-list>
                                                        ...
                                                        <nt:authors>
                                                            ...
                                                            <c:if test="${internalUser != ''}">
                                                                <nt:user username="${internalUser}">
                                                                    <meta itemprop="name" content="<nt:user-firstname/> <nt:user-lastname/>"/>
                                                                    <meta itemprop="sameAs" content="<nt:user-link-friendly/>"/>
                                                                    by <span class="itacaput"><a href="/english<nt:user-link-friendly urlpart='/staff/'/>" class="her" alt="<nt:user-firstname/> <nt:user-lastname/>" title="<nt:user-firstname/> <nt:user-lastname/>"><nt:user-firstname/> <nt:user-lastname/></a></span>									
                                                                </nt:user>
                                                            </c:if>	 
                                                            <c:if test="${internalUser == '' && authorName != ''}">
                                                                <meta itemprop="name" content="<nt:author-name/>"/>
		...
		<div id="rcjsload_a23776"></div>
			...
			rcel.src = "http://trends.revcontent.com/serve.js.php?w=44554&t="+rcel.id+"&c="+(new Date()).getTime()+"&width="+(window.outerWidth || document.documentElement.clientWidth)+"&referer="+referer;
			rcel.async = true;
			var rcds = document.getElementById("rcjsload_a23776"); rcds.appendChild(rcel);
			})();
			</script>
