...
<div class="block corres" id="CorresContenedor">
	<a href="http://multimedia.telesurtv.net/web/telesur/#!en/lista/noticia/corresponsales"><h6>Correspondents <cms:img src="/arte/i-corres.jpg" scaleType="2" alt="Telesur" /></h6></a>
