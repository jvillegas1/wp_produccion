...
<channel>
 ...
 <nt:news-list order="priority,modification-date" tags="USElection2016" size="${cantidad}" publication="9">
      <item>
  ...
  <c:otherwise>
<nt:news-list category="/system/categories/SubSecciones/news/latinaamerica/" order="user-modification-date DESC" size="10" >
   <item>
     <title><![CDATA[<nt:title/>]]></title>
     <link><%=request.getScheme()+"://"+request.getServerName()%><nt:link/></link>
     <description><![CDATA[<nt:sub-title/>]]></description>
