                        ...
                        <div class="wrap notaAgenda">				
                            ...
                            <div class="nworldtop cont">
                                <span class="itacaput" itemprop="articleSection">	
                                    <a href="/english/section/audio/index.html" class="her" alt="<nt:section-description/>" title="<nt:section-description/>"><nt:section-description/></a>						
                                    <nt:categories>
