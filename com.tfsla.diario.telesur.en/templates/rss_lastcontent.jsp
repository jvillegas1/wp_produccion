...
<channel>
 ...
 <nt:news-list advancedfilter="(seccion:news OR seccion:blog OR seccion: opinion)" order="user-modification-date desc" size="50">
  ...
  <figure>
     <nt:preview-image>
           <img  <enclosure url="<%=request.getScheme()+"://"+request.getServerName()%><nt:image-path />" type="image/jpeg"><![CDATA[<nt:image-description/>]]></enclosure>  /> 
     </nt:preview-image >
 </figure>
  ...
  <figure>
   <video>
     ...
     <content:encoded><![CDATA[<nt:body />]]></content>
      </item>
 </nt:news-list>
  </c:when>
