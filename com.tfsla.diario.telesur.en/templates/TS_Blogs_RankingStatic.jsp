...
<div class="cont">
	...
	<div class="slideVerticalNew carousel">
			<nt:news-list newstype="bloggers" order="user-modification-date desc" section="blog" from="7d" age="7d" publication="9">
				<% cont1++; %>
			</nt:news-list>
			<ul <% if (cont1 > 5) { %> id="slideVerticalBlog1" <% } %> >
		            <nt:news-list newstype="bloggers" order="user-modification-date desc" section="blog" size="10" from="7d" age="7d" publication="9"> 
					<li>
					    <div class="modnews">
	...
	<div id="MostRead">            
		<div class="slideVerticalNew carousel">
			<nt:news-list newstype="bloggers" order="most-read" section="blog" from="7d" age="7d" publication="9">
				<% cont2++; %>
			</nt:news-list>
			<ul <% if (cont2 > 5) { %> id="slideVerticalBlog2" <% } %> >
	                    	<nt:news-list newstype="bloggers" order="most-read" section="blog" size="10" from="7d" age="7d" publication="9"> 
		                        <li>
		                            <div class="modnews">
		                                <div class="contimgsli">
		                                	<nt:preview-image>									
	...
	<%--<div id="MostShared">            
		<div class="slideVerticalNew carousel">
			...
			<%--<nt:news-list newstype="bloggers" order="most-positive-evaluations" section="blog" from="7d" age="7d" publication="9">
				<% cont3++; %>
			</nt:news-list>
			<ul <% if (cont3 > 5) { %> id="slideVerticalBlog3" <% } %> >
	                    	<nt:news-list newstype="bloggers" order="most-positive-evaluations" section="blog" size="10" from="7d" age="7d" publication="9"> 
		                        <li>
		                            <div class="modnews">
		                                <div class="contimgsli">
		                                	<nt:preview-image>									
