...
%>
	...
	<div class="cont">
		...
		<div class="slideVerticalNew carousel">
				<nt:news-list section="imreporter" order="user-modification-date desc" size="30" from="30d" age="30d"  state="publicada" publication="9"  >
				...
				<ul <% if (contCantNotaAprobada > 7) { %> id="slideVerticalNew" <% } %> >				
			            <nt:news-list section="imreporter" order="user-modification-date desc" size="<%=contCantNotaTotal %>" from="30d" age="30d" state="publicada" publication="9"> 
		...
		<div id="MostRead">            
			<div class="slideVerticalNew carousel">
				<nt:news-list section="imreporter" order="most-read" from="30d" age="30d" state="publicada" publication="9">
				...
				<ul <% if (contNotaAprobadaMR > 7) { %> id="slideVerticalNew1" <% } %> >
		                    	<nt:news-list section="imreporter" order="most-read" size="<%=contCantNotaTotalMR %>" from="30d" age="30d" state="publicada" publication="9"> 
	...
	<%--	<div id="MostShared">            
			...
			<script type="text/javascript">
				...
				<%--<nt:news-list section="imreporter" order="most-recommended" from="7d" age="7d" state="publicada" publication="8">
					<c:set var="statecont3" scope="page">${news.state}</c:set> 
					<%
					String statecont3 = (String) pageContext.getAttribute("statecont3");    
					if(!statecont3.equalsIgnoreCase("pendienteModeracion") && !statecont3.equalsIgnoreCase("rechazada")){ 
						contNotaAprobadaMPE ++; 
					}
					if  (contNotaAprobadaMPE < 11) contCantNotaTotalMPE ++ ;
					%>
				</nt:news-list>
				<ul <% if (contNotaAprobadaMPE > 7) { %> id="slideVerticalNew2" <% } %> >
		                    	<nt:news-list section="imreporter" order="most-positive-evaluations" size="<%=contCantNotaTotalMPE %>" from="7d" age="7d" state="publicada" publication="8"> 
		                        <c:set var="stateMPV" scope="page">${news.state}</c:set> 
					<%
					String estadoMPV = (String) pageContext.getAttribute("stateMPV");    
					if(!estadoMPV.equalsIgnoreCase("pendienteModeracion") && !estadoMPV.equalsIgnoreCase("rechazada")){
					%>	
					<li>
		                            <div class="modnews">
		                                <div class="contimgsli">
