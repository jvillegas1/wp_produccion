                                ...
                                <div class="colblogl">														
                                    <div class="topblog">
                                        <nt:conditional-include oncondition="${news.hideTime == 'false'}">
                                            <div class="topblogleft" itemprop="datePublished"><fmt:setLocale value="en_US"/> <fmt:formatDate pattern="d MMMM yyyy - hh:mm a" value="${news.lastModificationDate}" /></div>
                                        </nt:conditional-include>
                                        <%--<div class="sharop1"> --%>
                                        	<div class="barra-redes" style="margin-left:315px">
                                    ...
                                    <div class="contentblog">
                                       ...
                                       <%--  <div class="valorarNews">
                                           <a title="I Like" onclick="makeVoteExterior(this)" style="cursor:pointer;">
                                                <cms:img src="/arte/simegusta.jpg" alt="I Like" title="I Like" /> 
                                            ...
                                            <a title="I don't Like" onclick="makeVoteExterior(this)" style="cursor:pointer;">
                                                <cms:img src="/arte/nomegusta.jpg" style="top:7px" alt="I don't Like" title="I don't Like" /> 
                                                        ...
                                                        <nt:authors>
                                                            ...
                                                            <c:if test="${internalUser != ''}">
                                                                <nt:user username="${internalUser}">
                                                                    ...
                                                                    By <span class="itacaput"><a href="<nt:user-link-friendly urlpart='/english/staff/'/>" class="her" alt="<nt:user-firstname/> <nt:user-lastname/>" title="<nt:user-firstname/> <nt:user-lastname/>"><nt:user-firstname/> <nt:user-lastname/></a></span>									
                                                                </nt:user>
                                                            </c:if>	 
