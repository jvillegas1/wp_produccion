jQuery.fn.GetProgramas = function(primero, ultimo, programa){
			...
			.done(function(data){
				...
				$.each(data,function(i){
					...
					$ASIDE += '<div class="contImg"><a href="#player" onclick="'+watchVideoFN+'" title="'+Descripcion+'"><img src="/arte/ico-play.png" alt="Telesur" class="icoPlay"><img src="'+imagen+'" height="82" alt="Telesur"></a></div>';
...
jQuery.fn.GetHeaders = function(programa){
		...
		//PARA EL DESTACADA
		$ASIDE += '<div class="data" id="data"><em class="fecha">'+fecha+'</em> <em class="rep">'+visitas+' Views</em><h2>'+titulo+'</h2><p>'+descripcion+'</p><a href="'+url_descarga+'?descarga" target"_blank">Download</a>';
