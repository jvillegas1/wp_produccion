...
<script language="javascript">
      ...
      function ver_todos_coment(page){
       $.post("/system/modules/com.tfsla.diario.telesur/elements/webusers/TS_Profile_CommentList.jsp",{pageComent: page,apodo: '<%=apodo%>', tipoPerfil: '<%=tipoPerfil %>'}, function(data){      
...
<div class="rowInt">
        <div class="headers blue">Últimos comentarios</div>
        <div class="cont">
<% } %>
...
<%
	...
	{
%>	
            	  <a id="paginador_<%=pageComent %>" style="margin:0px 10px" class="btnSeeMore" href="javascript:ver_todos_coment('<%= pageComent + 1 %>');" alt="Ver Más" title="Ver Más">Ver Más</a>
