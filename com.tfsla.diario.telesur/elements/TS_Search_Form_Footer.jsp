...
<form name="buscadorFooter" class="formSearchFooter" action="/buscar.html" method="post">    
    <div class="wrapper">
        <div class="cont">
            <div class="serchbox">
                <div class="searchboti">Buscar</div>
                <div class="searchbarbot">
                    <input class="mailbot1" type="text" required  name="search_form" value="<%=search_form %>" >            
                    <input id="subscribebot1" type="submit" value="Buscar" name="submit">
                </div>
            </div>
        </div>
    </div>
