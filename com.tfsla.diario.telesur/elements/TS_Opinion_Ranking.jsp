...
<%
	try{
	%>
		<c:import url="http://www.telesurtv.net/_static_rankings/static_rankingCategory_opinion.html"/>
	<%
	}
	catch (Exception e){
		out.print("cargando...");
...
<div class="cont">
	...
	<div class="slideVerticalNew carousel">
			<nt:news-list order="user-modification-date desc" section="opinion" from="7d" age="7d" publication="8">
				<% cont1++; %>
			</nt:news-list>
			<ul <% if (cont1 > 6) { %> id="slideVerticalBlog1" <% } %> >
		            <nt:news-list  order="user-modification-date desc" section="opinion" size="5" from="7d" age="7d" publication="8"> 
					<li>
					    <div class="modnews">
	...
	<div id="MostRead">            
		<div class="slideVerticalNew carousel">
			<nt:news-list  order="most-read" section="opinion" from="7d" age="7d" publication="8">
				<% cont2++; %>
			</nt:news-list>
			<ul <% if (cont2 > 6) { %> id="slideVerticalBlog2" <% } %> > 
	                    	<nt:news-list  order="most-read" section="opinion" size="5" from="7d" age="7d" publication="8"> 
		                        <li>
		                            <div class="modnews">
		                                <div class="contimgsli">
		                                	<nt:preview-image>									
	...
	<div id="MostShared">            
		<div class="slideVerticalNew carousel">
			...
			<div id="cx_6fa00f046284e7e5f5f4cfcd4d42dc555f89494e" style="display:none"></div>
				<script type="text/javascript">
				    var cX = cX || {}; cX.callQueue = cX.callQueue || [];
				    cX.callQueue.push(['insertWidget', {
				        widgetId: '6fa00f046284e7e5f5f4cfcd4d42dc555f89494e',
				        insertBeforeElementId: 'cx_6fa00f046284e7e5f5f4cfcd4d42dc555f89494e',
			...
			<%--<nt:news-list  order="most-positive-evaluations" section="opinion" from="7d" age="7d" publication="8">
				<% cont3++; %>
			</nt:news-list>
			<ul <% if (cont3 > 5) { %> id="slideVerticalBlog3" <% } %> >
	                    	<nt:news-list newstype="bloggers" order="most-positive-evaluations" section="blog" size="5" from="7d" age="7d" publication="8"> 
		                        <li>
		                            <div class="modnews">
		                                <div class="contimgsli">
		                                	<nt:preview-image>									
