<div class="col-4quat">
	<div class="cont">
			<select class="fech-marcador white selreg sport-bt" id="futbol" name="futbol" onchange="changeSport('futbol')">		 	
		        	<option class="opt" value="">F&uacute;tbol</option>
		        	...
		        	<option class="opt" value="17">El Calcio</option>
		        	<option class="opt" value="18">Inglaterra</option>
		        	<option class="opt" value="19">Copa Am&eacute;rica</option>
		        	<option class="opt" value="20">Copa Oro</option>
			</select>
			...
			<select class="fech-marcador white selreg sport-bt" id="nfl" name="nfl" onchange="changeSport('nfl')">		 	
		        	<option class="opt" value="">F&uacute;tbol Americano</option>	        
...
<script type="text/javascript">
	...
	var pages = [   "http://static.telesurtv.net/html/es/v3/index.html?channel=deportes.futbol.champions.fixture&lang=es_LA",
			...
			"http://static.telesurtv.net/html/es/v3/index.html?channel=deportes.futbol.italia&lang=es_LA",
			"http://static.telesurtv.net/html/es/v3/index.html?channel=deportes.futbol.premierleague&lang=es_LA",
			"http://static.telesurtv.net/html/es/v3/index.html?channel=deportes.futbol.copaamerica&lang=es_LA",
			"http://static.telesurtv.net/html/es/v3/index.html?channel=deportes.futbol.copaoro&lang=es_LA"];
