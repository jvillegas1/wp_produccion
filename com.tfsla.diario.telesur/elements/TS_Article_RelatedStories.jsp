	...
	<nt:related-news size="10">	
		<nt:conditional-include oncondition="${newslist.size > 4}">
			...
			<div class="cont desktop">					
				<div class="headlive">Noticias Relacionadas</div>           
				<div class="slideVerticalNew2 carousel">
					<ul id="slideVerticalRelated">
			</c:if>				
						<li>
							<div class="modnews">
								<div class="contimgsli">								
									...
									<div class="titslidenew"><a href="<nt:link/>" class="her" alt='<nt:title value="home"/>' title='<nt:title value="home"/>'><nt:title value="home"/></a></div>
								<div class="clear"></div>
							</div>    
						</li>
		</nt:conditional-include>
