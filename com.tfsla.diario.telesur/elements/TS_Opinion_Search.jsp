...
%>
<div class="blueBar">
	<form name="buscador" class="formSearch1" action="/buscarOpinion.html" method="post">    	
		<div class="wrapper">
			<div class="row clear">
				<div class="col">
					<div class="cont">
						...
						<div class="contesel">
							<div class="filasel">
								<div class="txtsel">Filtrar por:</div>
						...
						<div class="contesel  sclear" >
							<div class="filasel">
								<div class="txtsel">Publicado:</div>
