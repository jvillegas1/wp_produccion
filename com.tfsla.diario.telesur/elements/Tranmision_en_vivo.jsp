        ...
        <tr>
         ...
         <tr> 
           	<td height="300" width="300">
            			<iframe width="96%" height="525" align="middle" frameborder="0" mozallowfullscreen="" webkitallowfullscreen="" scrolling="no" allowfullscreen="" id="envivoid" name="envivo" src="<%= urlStreaming%>" style="margin-top: 19px; margin-left: -6px;"></iframe>
