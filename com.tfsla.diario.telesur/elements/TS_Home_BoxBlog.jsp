...
<nt:news-list order="priority DESC, user-modification-date asc" zone="bloguers" onmainpage="home" searchindex="<%=index%>">
	<nt:conditional-include onposition="first">
		<article class="middleArt">
			<div class="headBlue"><a href="http://www.telesurtv.net/seccion/blog/index.html">Blogueros</a></div>
