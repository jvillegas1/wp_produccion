...
<%--La variable index proviene de  TS_Home_Destacada_Default.jsp, el objetivo de esta es realizar el newslist por indices--%>
<nt:news-list order="priority DESC,user-modification-date" zone="destacada_secundaria" onmainpage="home" size="4" searchindex="<%=index%>">
		...
		<nt:conditional-include oncondition="${FirstPos == true}">
			<div class="aside">
				<div class="boxProg">
					...
					<ul>
						<c:import url="http://www.telesurtv.net/_static_rankings/static_liveBoxHome.html"/>
					</ul>
				<% } catch (Exception e){%> Cargando... <% } %>					
					
					<a href="/seccion/programas/index.html">Ver programación completa</a>
				</div>
				<article class="dest">
