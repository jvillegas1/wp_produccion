...
<nt:news-list zone="world_carousel" onmainpage="home" order="user-modification-date desc">
<%--<nt:news-list category="news/world" size="6" order="priority asc,user-modification-date desc">--%>
	<nt:conditional-include onposition="first">
		<div class="block world">
			<a href="http://www.telesurtv.net/SubSecciones/news/world/index.html"><h6>Mundo <cms:img src="/arte/redes/mundo.png" scaleType="2" alt="Telesur" /></h6></a>
