...
<% } else { 
	...
	if (currentUri.indexOf("/news/") > -1 ) {
		try{
		%>
			<c:import url="http://www.telesurtv.net/_static_rankings/static_rankingCategory_noticias.html?ram=<%=r.nextInt()%>"/>
		<%
		}
		catch (Exception e){
			out.print("cargando...");
	...
	if (currentUri.indexOf("/imreporter/") > -1 ){

		try{
		%>
			<c:import url="http://www.telesurtv.net/_static_rankings/static_rankingCategory_reportero.html?ram=<%=r.nextInt()%>"/>
		<%
		}
		catch (Exception e){
			out.print("cargando...");
	...
	<div class="cont">
		...
		<div id="MostShared">            
			...
			<script type="text/javascript">
				...
				<%--<nt:news-list section="<%=seccion%>" order="most-recommended" from="7d" age="7d" state="publicada" publication="8">
				...
				<ul <% if (contNotaAprobadaMPE > 7) { %> id="slideVerticalNew2" <% } %> >
		                    	<nt:news-list section="<%=seccion%>" order="most-positive-evaluations" size="<%=contCantNotaTotalMPE %>" from="7d" age="7d" state="publicada" publication="8"> 
