...
<nt:news-list order="priority asc, user-modification-date desc" zone="voices_soyreporteo" onmainpage="home" searchindex="<%=index%>">
	<nt:conditional-include onposition="first">
		<article>
			<div class="headBlue"><a href="http://www.telesurtv.net/seccion/imreporter/index.html">Soy Reportero</a></div>
