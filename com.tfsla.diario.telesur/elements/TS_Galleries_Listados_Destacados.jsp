...
%>
    ...
    <nt:news-list zone="enimagenes" order="priority asc,user-modification-date" onmainpage="home" page="<%=pagina%>" size="<%=size%>">
	 <% i++;%>
	 ...
	 <%}%>">
					...
					<a href="<nt:link/>" title="${imageDescription}">	
						...
						<span itemprop="name headline"><small>${news.imagescount} | </small>${imageDescription}</span>
					</a>
