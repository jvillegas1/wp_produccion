...
<%
    ...
    try {
        ...
        if (nombre.equals("") || profesion.equals("") || apellido.equals("") || pais.equals("") || gRecaptchaResponse.equals("") || mensaje.equals("") || curriculum.equals("")) {
            error = true;
        } else {
...
<%!
    ...
    public class SendEmailWithAttachment {
        ...
        public void sendEmail() {
            ...
            String to = "empleo@telesurtv.net";
