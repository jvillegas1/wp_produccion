...
<script>
    ...
    var busqueda = function (active) {
       // console.log(active);
        ...
        var api = "http://multimedia.telesurtv.net/api/clip/?detalle=completo=true&ultimo=5&hashtag=" + hashtag[0];
       // console.log(api);
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                for (var j = 0; j < len; j++) {
                    ...
                    twitter.push(entry.programa.twitter);
                     if (entry.programa.twitter != null){
                         twitter.push(entry.programa.twitter);
                    }else{
                    	twitter.push("@teleSURtv");
                ...
                itemsImport.push("<div class='aside'>" +
                        ...
                        "<small><a href='"+urlTwitter+twitter[active]+"' target='_blank' class='videotwitter'>" + twitter[active] + "</a></small>" +
                        " </div>" +
