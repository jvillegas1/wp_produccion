...
<%
  ...
  */
  int cont = 0;
%>
<nt:news-list order="most-commented" section="news" from="7d" age="7d">
	<% cont++; %>
</nt:news-list>

<div class="rowInt">
	<div class="headers blue">Tus comentarios</div>
	<% if (cont > 0) { %>
		<div class="cont">
			<nt:news-list order="most-commented" size="3" section="news" from="7d" age="7d">
				<div class="commentboxjs">
					...
					<div class="graybox">
						...
						<div class="rightboxju">
							...
							<div class="rsju">
								<ul>
									<li>${news.commentcount} Respuestas</li>
									<li>
	...
	<% } else { %>
		<div class="cont">
			<div class="modnews">
				<div class="titlepopbox">En estos momentos no tenemos notas "Más comentadas".</div>
			</div>
		</div>
	<% } %>
</div>
