...
<%
  ...
  */
  int cont = 0;
%>
<nt:news-list newstype="bloggers" order="most-commented" section="blog" from="7d" age="7d">
	<% cont++; %>
</nt:news-list>
...
<% if (cont > 0) { %>	
	<div class="cont">
		<ul>
			<nt:news-list newstype="bloggers" order="most-commented" size="3" section="blog" from="7d" age="7d" >
				<li >
					<div class="popbox">
