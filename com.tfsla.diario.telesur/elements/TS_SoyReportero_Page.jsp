...
<nt:news-list section="reportero" order="priority ASC, user-modification-date desc" onmainpage="section" zone="destacada" size="1"> 
...
<div class="row clear">
	<div class="col">
		<div class="rowInt">
			<div class="cont">			
			      		<nt:news-list section="imreporter" order="user-modification-date desc" size="<%=size%>" page="<%=pagina%>" state="publicada">
					...
					<nt:conditional-exclude oncondition="${friendlyUrl == excludeLink}">
						<div class="news lineanews2" itemscope itemtype="http://schema.org/Article">
							...
							<div class="txt-news">
								...
								<div class="resumrepo" itemprop="description alternativeHeadline"><nt:sub-title/></div> 
								</nt:conditional-include>
									...
									<nt:user username="${internalUser}">
										<div class="new-bajada2" itemprop="author" itemscope itemtype="http://schema.org/Person">
											<div class="autrepo">	
												...
												<a href="<%=urlFrendlyClean%>" class="her"><nt:user-firstname/> <nt:user-lastname/></a>
											</div>
					...
					<nt:conditional-include onposition="last">
						...
						<nt:conditional-include oncondition="${newslist.size == 7}">
							...
							<nt:news-list section="imreporter" order="user-modification-date desc" size="<%=size%>" page="<%=pagina+1%>" state="publicada">						
							...
							<c:if test="${hayMas == 'true'}" >
								...
								<div class="cont" id="paginador" > 
									<a class="btnrepsm" href="javascript:cargarMasNotas('<%=pagina+1%>','<%=size%>');"><img src="/arte/down-arrow.png" width="24" height="13" alt="" />Ver más reportes</a>
								</div>	
							</c:if>	
						</nt:conditional-include> 
					</nt:conditional-include> 
