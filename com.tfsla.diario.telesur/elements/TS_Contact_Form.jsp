        ...
        $("#click").click(function () {
            ...
            if (nombre == "") {
                ...
                if (correo == "") {
                    ...
                    $("#error").empty();
                    $("#errorInf").fadeIn(300).delay(1500).fadeOut(1600);
                    $("#error").append(" debe colocar su Correo");
                    return false;
                }
                else {
                    if (mensaje == "") {
                        ...
                        if (correoContacto != "") {
                            ...
                            var url = "/system/modules/com.tfsla.diario.telesur/elements/TS_Contact_Page.jsp"; // El script a dónde se realizará la petición.
                            $.ajax({
                                type: "POST",
                                url: url,
...
<div class='centrar errorInfo' id="errorInf" style="display: none;"><b>Alerta!</b><span id="error"></span></div>
        <form id="form" method="post" action="/pages/contacto.html#coment">
            ...
            <div class="btnForm clear">
                <input class="enviar env" type="submit" value="Enviar" id="click"><a class="cancelar" href="#">Cancelar</a>
            </div>
        </form>
    </div>
</div>
