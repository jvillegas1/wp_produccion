...
<script>
    function send(sdia, all, tz) {
        ...
        console.log("Se presionó el dia: "+ sdia);
    }
                            ...
                            <div class="img-shows">
                                ...
                                <ul class="soloaudio">
                                    <li class="soloaudioli">
                                        <a id="btn-svivo" href="#"><img src="/export/sites/telesur/arte/ico-en-vivo.png" width="18" height="18" alt="Señal en Vivo"></a> <span id="tit-svivo">Señal en Vivo</span>
                                    </li>
                                    <li class="soloaudioli">
                                        <a  id="btn-saudio" href="#"><img src="/arte/AUDIO_.png" width="18" height="18" alt="Solo Audio"></a> <span id="tit-saudio">Solo Audio</span>
                                    </li>
                                </ul>
                                <!--Fin menu solo audio-->
