...
session.setAttribute("seccion","opinión");
...
int position = 0;
String categoryPath = "/SubSecciones/opinion/"+category+"/"; 
%>
<%
if(category.equals("articles")){
%>
<%-- List Articles --%>
<nt:news-list order="user-modification-date desc" section="opinion" page="<%=pagina%>" category="<%=categoryPath%>" size="<%=size%>">
	<!--Noticia -->
