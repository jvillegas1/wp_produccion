...
<!-- blueBar -->  
<form method="POST" action="/seccion/blog" name="buscadorBlog" >
<div class="blogBar">
  <div class="wrapper">
      <div class="row clear">
          <div class="col">
              <div class="cont">
                  <div class="contesel">
                      <div class="filasel">
                          <div class="txtsel">Mostrar:</div>
                          <select name="display_search" data-val="<%=display_search %>" class="sel" id="order">
                              <option value="LAST">Últimas entradas</option>
                              <option value="COME">Más Leídos</option>
                              <option value="COMP">Más Valorados</option>
                          </select>
                      </div>
                  </div>
                  <div class="contesel">
                      <div class="filasel">
                          <div class="txtsel">Autores:</div>
                  ...
                  <div class="contesel">
                      <div class="filasel">
                          ...
                          <form method="post">
                              ...
                              <input id="subscribe" type="submit" value="Buscar" name="submit"></form>
                      </div>
                  </div>
              </div>
          </div>
