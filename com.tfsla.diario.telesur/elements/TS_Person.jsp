...
<div class="row clear">	
	<div class="cont">
		<div class="titlereg">Noticias de <strong> <%=personFriendly%></div>
	...
	<div class="ressearch" itemscope itemtype="http://schema.org/Article">
		<ul>
		<nt:news-list order="user-modification-date desc" size="10" persons="<%=personName%>" publication="8" state="publicada">
