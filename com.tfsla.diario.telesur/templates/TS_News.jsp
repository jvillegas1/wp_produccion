...
<html>
<head>
	<meta name="description" content="Sección de noticias Nacionales e internacionales"/>
...
<body>
	...
	<cms:include page="../elements/TS_Common_Header.jsp" >
		<cms:param name="pageTitle">Noticias</cms:param>
			...
			<div class="row clear">     
				...
				<div class="col-six">
					...
					<div class="row clear">  
						<div class="col">
							<div class="rowInt">                
								<div class="headers blue">América Latina</div>
								<div class="cont">
									<cms:include page="../elements/TS_News_Categories.jsp">
										<cms:param name="category">/SubSecciones/news/latinaamerica/</cms:param>
									</cms:include>                
								</div>                                            
							</div>              
						</div>
					...
					<div class="row clear">  
						<div class="col">
							<div class="rowInt">
								<div class="headers blue">Mundo</div>
								<div class="cont">
									<cms:include page="../elements/TS_News_Categories.jsp">
										<cms:param name="category">/SubSecciones/news/world/</cms:param>
									</cms:include>     
								</div>    
								<!-- banner2 -->
								<div class="row clear"> 
					...
					<div class="row clear">  
						<div class="col">
							<div class="rowInt">
								<div class="headers green">Deportes</div>
								<div class="cont">
									<cms:include page="../elements/TS_News_Categories.jsp">
										<cms:param name="category">/SubSecciones/news/sport/</cms:param>
									</cms:include>                      
								</div>                 
							</div>        
						</div>
					...
					<div class="row clear">  
						<div class="col">
							<div class="rowInt">
								<div class="headers cyan">Cultura</div>
								<div class="cont">
									<cms:include page="../elements/TS_News_Categories.jsp">
										<cms:param name="category">/SubSecciones/news/culture/</cms:param>
									</cms:include>                    
								</div>    
