...
%>
	...
	<form action="/posts/process.html" id="posts" name="posts" method="post" enctype="multipart/form-data">
		...
		<div class="row clear">
			<div class="col ">
				<div class="cont titreg desktop"> Tienes una foto para compartir </div>													
				...
				<div class="col-mid">
					<div class="cont">	
						...
						<input type="hidden" id="fuentes" name="fuentes[]" value="" autocomplete="off">							
						
						<input type="submitstory" placeholder="Descripcion *" name="copete" value="" id="copete" autocomplete="off">	
						<div class="reg-form" id="diverrorcopete" name="diverrorcopete" style="display:none;margin:0;float:right">					
							<div class="anote error" style="margin:0;">Seleccionar una descripcion.</div>
						</div>
				...
				<div class="col-mid">
					<div class="border_form" style="border-left:1px solid #CCC">
						<div class="cont">
							...
							<input id="cancelar" type="button" onclick="window.location.href='/seccion/joinus/';" value="Cancelar" title="Cancelar publicación">
						</div>
					</div>
				</div>
				<!-- fin col-midx -->
...
<script type="text/javascript">
	...
	function ValidateForm(mode){
		...
		if( e_titulo || e_copete || e_imagen_vacia || e_imagen_count || e_imagen_size || e_imagen_format ){
			if ( e_titulo || e_temas || e_temas_espacios || e_imagen_vacia || e_imagen_count || e_imagen_size || e_imagen_format || e_fuente  ) {
			...
			if (e_temas_espacios ) 
				document.getElementById('diverrorcopete').style.display = "block";
			else	
				document.getElementById('diverrorcopete').style.display = "none";
