...
<div id="freestyle">
     ...
     <ul>
     <li>
     <a  href="http://www.telesurtv.net/rss/RssPortada.html" target="_blank">Home</a></li>
     <li>
     <a  href="http://www.telesurtv.net/rss/RssLatinoamerica.html" target="_blank">Latinoamérica</a></li>
     <li>
     <a href="http://www.telesurtv.net/rss/RssMundo.html" target="_blank">Mundo</a></li>
     <li>
     <a  href="http://www.telesurtv.net/rss/RssDeporte.html" target="_blank">Deporte</a></li>
     <li>
     <a  href="http://www.telesurtv.net/rss/RssCultura.html" target="_blank">Cultura</a></li>
     <li>
     <a  href="http://www.telesurtv.net/rss/RssOpinion.xml" target="_blank">Opinión</a></li>
     <li>
     <a  href="http://www.telesurtv.net/rss/RssBlogs.xml" target="_blank">Blog</a></li>
     </ul>
</div>

<div class="cont">
<p class="sur"><strong>(*) Recomendación:</strong>  Para una mejor lectura instalar en tu navegador un lector de RSS.</p>
</div>
</div>	    
