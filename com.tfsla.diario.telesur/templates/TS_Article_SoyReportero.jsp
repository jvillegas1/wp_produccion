						...
						<div class="capworldtop">
							<div class="caplw">
								...
								<nt:conditional-include oncondition="${news.hideTime == 'false'}">
									<div class="capdate" itemprop="datePublished">Fecha de publicación <fmt:setLocale value="es_ES"/> <fmt:formatDate pattern="d MMMM yyyy - hh:mm a" value="${news.lastModificationDate}" /></div>
								</nt:conditional-include>
