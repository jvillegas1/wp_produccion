...
<channel>
 ...
 <nt:news-list advancedfilter="(seccion:news OR seccion:blog) AND NOT home.zone:ultimas" order="user-modification-date desc" size="50">

      <item>
     <title><![CDATA[<nt:title/>]]></title>
     <link>http://www.telesurtv.net</link>
  ...
  <c:otherwise>
 <nt:news-list order="priority asc,user-modification-date desc" onmainpage="home"  zone="ultimas">
   <item>
     <title><![CDATA[<nt:title/>]]></title>
     <link>http://www.telesurtv.net</link>
     <description><![CDATA[<nt:sub-title/>]]></description>
