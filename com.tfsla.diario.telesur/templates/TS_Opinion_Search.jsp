...
<body>
	...
	<cms:include page="../elements/TS_Common_Header.jsp" >
	    <cms:param name="pageTitle">Opinión</cms:param>
	    <cms:param name="pageSeccion">opinion</cms:param>
	    <cms:param name="subMenu">no</cms:param>
	    <cms:param name="agenda">no</cms:param>
	</cms:include>
	
	<%-- <cms:include page="../elements/TS_Common_NavigationMobile.jsp" >
		<cms:param name="name">opinion</cms:param>  
		<cms:param name="titulo">opinion</cms:param>
	</cms:include> --%>
