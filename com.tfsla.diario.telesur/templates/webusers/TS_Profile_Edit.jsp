...
<% // si no hay usuario logueado lo redireccionamos al login */ 
if (!userIsLoggedIn) response.sendRedirect("/usuarios/login_nativo.html?P=/usuarios/editar_perfil.html");
%>
...
<body>
	...
	<cms:include page="../../elements/TS_Common_Header.jsp" >
		<cms:param name="pageTitle">Perfil</cms:param>
	...
	<div class="wrapper"><!--wrapper--> 
		...
		<div class="col">
			...
			<div class="cont titreg" style="margin-top:20px"> Editar perfil </div>
