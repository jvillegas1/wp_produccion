...
<channel>
 ...
 <nt:news-list order="priority,modification-date" author="${internalUser}" onmainpage="home" size="${cantidad}" >
      <item>
  ...
  <c:otherwise>
<nt:news-list newstype="bloggers" order="priority,modification-date" author="${internalUser}" size="20" >
   <item>
     <title><![CDATA[<nt:title/>]]></title>
     <link><%=request.getScheme()+"://"+request.getServerName()%><nt:link/></link>
     <description><![CDATA[<nt:sub-title/>]]></description>
