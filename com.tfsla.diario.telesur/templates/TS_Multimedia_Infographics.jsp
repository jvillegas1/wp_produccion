...
<script src="<cms:link>../resources/js/tabs.min.jquery.js</cms:link>"></script>
    ...
    <body>   
        ...
        <cms:include page="../elements/TS_Common_Header.jsp" >            
                <div class="subMenu">
                    <cms:param name="pageTitle">Infograf&iacute;a</cms:param>
		...
		<cms:param name="key">Advert-950x90</cms:param>
            ...
            <div class="wrap multimedia infografias">         
				...
				<cms:include page="TS_Common_Listado_Multimedia.jsp">					
					...
					<cms:param name="titulo">Infograf&iacute;a</cms:param>
				</cms:include>
		    </div>                                 		
                </div>     
		<div class="banners">
     ...
     <script type="text/javascript">
		   function loadMore(size, page) {      
		   	$("#cargando").html('<p class="loading" style="text-align:center;"><img src="/arte/loading2.gif" style=" height:100px; width:100px;"/></p>');      
		    	$("#reload-listado").load( 'listado.html?size=' + size + '&page=' +page+'&category=infographics&titulo=Infografia' , function( response, status, xhr ){
		    		$('#cargando').html("");
		    	});
