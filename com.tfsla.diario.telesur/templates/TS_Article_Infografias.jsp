                ...
                <div class="boxMmd int">
                        ...
                        <nt:categories>
                            <nt:conditional-include onposition="first">
                                <c:set var="id"><nt:category-name/></c:set>
                                    ...
                                    %>	
                                <a href="/SubSecciones/multimedia/infographics/index.html" class="her" alt="<nt:category-description/>" title="<nt:category-description/>"> > Infografía</a>									
                   ...
                   <%-- <cms:include page="../elements/TS_Common_Addthis-Sidebar.jsp">
                      ...
                      <div class="redesInterna">
                        ...
                        <div class="barra-addthis-contador"  style="margin-left:700px">  
		            <div class="addthis_sharing_toolbox"></div>
			    <script type="text/javascript" src="//s7.addthis.com/js/300/addthis_widget.js#pubid=ra-55e9c35eef85e1de" async="async"></script>
