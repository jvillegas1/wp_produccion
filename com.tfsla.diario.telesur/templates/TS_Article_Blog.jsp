...
<body>
	...
	<cms:include page="../elements/TS_Common_Header.jsp" >
		<cms:param name="pageTitle">Blog</cms:param>  
							...
							<div class="colblogl">														
								<div class="topblog">
									<nt:conditional-include oncondition="${news.hideTime == 'false'}">
										<div class="topblogleft" itemprop="datePublished"><fmt:setLocale value="es_ES"/><fmt:formatDate pattern="d MMMM yyyy" value="${news.lastModificationDate}" /></div>
												...
												<nt:preview-image>
													<div class="qnewworld" itemscope itemtype="http://schema.org/ImageObject">							
														...
														<nt:conditional-include oncondition="${(imageDescription != '') && (imageSource != '')}">
															...
															<img itemprop="contentURL" src="<nt:image-path width="178" height="178" scaletype='2'/>" width="178" height="178" alt='<nt:image-description/>' title='<nt:image-description/> | Foto: <nt:image-source/>' >
														</nt:conditional-include>
														<nt:conditional-include oncondition="${(imageDescription == '') && (imageSource != '')}">
															<meta itemprop="description" content='${news.titles[news.titleDetailNum]}'>	
															<img itemprop="contentURL" src="<nt:image-path width="178" height="178" scaletype='2'/>" width="178" height="178" alt='${news.titles[news.titleDetailNum]}' title='${news.titles[news.titleDetailNum]}| Foto: <nt:image-source/>' >
														</nt:conditional-include>	
														<nt:conditional-include oncondition="${(imageDescription != '') && (imageSource == '')}">
															<meta itemprop="description" content='<nt:image-description/>'>	
