...
function cargarMasNotas(_pagina, _size, _display_search, _filter_autor, _buscar_search){
			...
			$.post("/system/modules/com.tfsla.diario.telesur/elements/TS_Analisis_Page.jsp",
