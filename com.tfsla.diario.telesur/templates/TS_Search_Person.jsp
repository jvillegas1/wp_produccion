...
<head>
	...
	<cms:include page="../elements/TS_Common_Head.jsp" >
		<cms:param name="template">person</cms:param>
	</cms:include>
...
<body>
	...
	<cms:include page="../elements/TS_Common_Header.jsp" >
	    <cms:param name="pageTitle">Persona</cms:param>
	    <cms:param name="pageSeccion">person</cms:param>
