...
<body>
	...
	<div id="iframeBox">
	   	<div class="wpClose">
			<a class="close" style="cursor:pointer;"><p style="float: right; padding:10px; display:inline-block; color:white">Cerrar</p></a>
		</div>
			...
			<div class="row clear"> 
				...
				<div class="col-mid">
					...
					<div class="rowInt">
          					<div class="cont">
							<div class="txtformju">
								<div class="titboxju rojo">Ponte en contacto</div>
								<div class="txtstoryju">
									¿Tienes una historia o una foto que quieras compartir? O sabes de alguna historia que pienses que debamos cubrir, <a href="#" class="rojo">Por favor ponte en contacto con nosotros - AQUÍ.</a>
								</div>
