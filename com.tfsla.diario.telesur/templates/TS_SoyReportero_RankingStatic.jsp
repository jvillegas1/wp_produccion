...
%>
	...
	<div class="cont">
		...
		<div class="slideVerticalNew carousel">
				<nt:news-list section="imreporter" order="user-modification-date desc" size="30" from="15d" age="15d"  state="publicada" publication="8"  >
				...
				<ul <% if (contCantNotaAprobada > 7) { %> id="slideVerticalNew" <% } %> >				
			            <nt:news-list section="imreporter" order="user-modification-date desc" size="<%=contCantNotaTotal %>" from="15d" age="15d" state="publicada" publication="8"> 
		...
		<div id="MostRead">            
			<div class="slideVerticalNew carousel">
				<nt:news-list section="imreporter" order="most-read" from="15d" age="15d" state="publicada" publication="8">
				...
				<ul <% if (contNotaAprobadaMR > 7) { %> id="slideVerticalNew1" <% } %> >
		                    	<nt:news-list section="imreporter" order="most-read" size="<%=contCantNotaTotalMR %>" from="15d" age="15d" state="publicada" publication="8"> 
